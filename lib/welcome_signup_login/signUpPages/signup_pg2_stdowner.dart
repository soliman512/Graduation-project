...
// إنشاء الحساب باستخدام Firebase Authentication
      ...
      // Check if the profileImage is already a URL (from addAccountImage_owner)
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            shape: BoxShape.circle,
                            color: ispassword1number ? Colors.green : Colors.white,
                            border: Border.all(color: Color.fromARGB(255, 189, 189, 189)),
                          ),
                        ),
                        SizedBox(width: 10),
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            shape: BoxShape.circle,
                            color: ispassworduppercase ? Colors.green : Colors.white,
                            border: Border.all(color: Color.fromARGB(255, 189, 189, 189)),
                          ),
                        ),
                        SizedBox(width: 10),
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            shape: BoxShape.circle,
                            color: ispasswordspecialchar ? Colors.green : Colors.white,
                            border: Border.all(color: Color.fromARGB(255, 189, 189, 189)),
                          ),
                        ),
                        SizedBox(width: 10),
...
<<<<<<< HEAD
                            ...
                            icon: termsChecked
                                ? Icon(Icons.check_box_rounded, color: mainColor)
